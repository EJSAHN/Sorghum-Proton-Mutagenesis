...
Callable-space feature enrichment corrected for GBS ascertainment.
...
Outputs:
  outputs_feature_enrichment/tables/callable_feature_enrichment.csv
  outputs_feature_enrichment/tables/expected_callable_space_probs.csv
"""
...
def main() -> None:
    ...
    # -----------------------------
    # 4) Corrected feature-enrichment table
    # -----------------------------
    rows = []
    ...
    out_csv = paths.outputs_functional / "tables" / "callable_feature_enrichment.csv"
