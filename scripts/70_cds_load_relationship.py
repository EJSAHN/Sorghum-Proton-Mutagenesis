...
Build S7_CDS_Load_Relationship:
- Total_Mutations per sample
- CDS_Fraction per sample = (#Category == 'CDS') / total

IMPORTANT:
- Uses outputs_feature_enrichment/tables/events_annotated_v2.csv.gz
  (must exist; generated by step 50)

Output:
  outputs_feature_enrichment/tables/cds_load_stats.csv
"""
...
def main() -> None:
    ...
    out_path = paths.outputs_functional / "tables" / "cds_load_stats.csv"
